...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-24 bg-gradient-to-b from-white to-primary-50">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-slate-100 hover:border-primary-200">
                <div className="bg-primary-100 text-primary-600 rounded-full h-20 w-20 flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-300">
